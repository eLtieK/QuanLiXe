...
public class Trips {
    ...
    public static boolean check_driver_enough_performance(int drive_id, Trips.Destination start, Trips.Destination end) throws Exception {
        Drivers driver = Manager.getDriver(drive_id);
        int distance = Trips.getDistance(start, end);
        int performance_cost = distance / driver.getAverageSpeed();
        return (driver.getPerformance() >= performance_cost);
    }
