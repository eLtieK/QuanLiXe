    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(Schedule_maintenance, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Close)
    ...
    private void Schedule_maintenanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Schedule_maintenanceActionPerformed
        try {
            ...
            if (vehicle.is_maintenance()) {
                ...
                resetText();
                return;
            } else if (vehicle.getStatus().equals(Vehicles.Status.in_trip)) {
                JOptionPane.showMessageDialog(this, "vehicle is in trip");
                resetText();
                return;
            } else if (vehicle.getKm_before_maintenace() == 0) {
                JOptionPane.showMessageDialog(this, "Vehicle don't need maintenance");
                resetText();
                return;
            }
            setButtonTrue();
